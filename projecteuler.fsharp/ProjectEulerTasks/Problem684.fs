...
// Let S(k) = s(1) + ... + s(k). You are given S(20) = 1047.
// Further let f(i) be the Fibonacci sequence defined by f(0) = 0, f(1) = 1 and f(i) = f(i - 1) + f(i - 2) for all i => 2.
// Find S(f(2)) + .. + S(f(90)). Give your answer modulo 1000000007.
