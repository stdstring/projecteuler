...
type RationalNumber32Tests() =
    ...
    member public this.IsZero() =
        ClassicAssert.IsTrue((new RationalNumber32(0, 1)).IsZero)
        ClassicAssert.IsFalse((new RationalNumber32(2, 1)).IsZero)
        ClassicAssert.IsFalse((new RationalNumber32(2, 3)).IsZero)
        ClassicAssert.IsFalse((new RationalNumber32(-2, 1)).IsZero)
        ClassicAssert.IsFalse((new RationalNumber32(-2, 3)).IsZero)

    [<Test>]
    member public this.IsInteger() =
        ClassicAssert.IsTrue((new RationalNumber32(0, 1)).IsInteger)
        ClassicAssert.IsTrue((new RationalNumber32(1, 1)).IsInteger)
        ClassicAssert.IsTrue((new RationalNumber32(2, 1)).IsInteger)
        ClassicAssert.IsTrue((new RationalNumber32(-1, 1)).IsInteger)
        ClassicAssert.IsTrue((new RationalNumber32(-2, 1)).IsInteger)
        ClassicAssert.IsFalse((new RationalNumber32(1, 2)).IsInteger)
        ClassicAssert.IsFalse((new RationalNumber32(2, 3)).IsInteger)
        ClassicAssert.IsFalse((new RationalNumber32(-1, 2)).IsInteger)
        ClassicAssert.IsFalse((new RationalNumber32(-2, 3)).IsInteger)
    ...
    member public this.Compare() =
        // two integer numbers
        ClassicAssert.IsTrue(new RationalNumber32(2) < new RationalNumber32(3))
        ClassicAssert.AreEqual(-1, (new RationalNumber32(2) :> IComparable).CompareTo(new RationalNumber32(3)))
        ClassicAssert.IsTrue(new RationalNumber32(-3) < new RationalNumber32(-2))
        ClassicAssert.AreEqual(-1, (new RationalNumber32(-3) :> IComparable).CompareTo(new RationalNumber32(-2)))
        ClassicAssert.IsTrue(new RationalNumber32(2) = new RationalNumber32(2))
        ClassicAssert.AreEqual(0, (new RationalNumber32(2) :> IComparable).CompareTo(new RationalNumber32(2)))
        ClassicAssert.IsTrue(new RationalNumber32(-2) = new RationalNumber32(-2))
        ClassicAssert.AreEqual(0, (new RationalNumber32(-2) :> IComparable).CompareTo(new RationalNumber32(-2)))
        ClassicAssert.IsTrue(new RationalNumber32(3) > new RationalNumber32(2))
        ClassicAssert.AreEqual(1, (new RationalNumber32(3) :> IComparable).CompareTo(new RationalNumber32(2)))
        ...
        ClassicAssert.AreEqual(1, (new RationalNumber32(-2) :> IComparable).CompareTo(new RationalNumber32(-3)))
        // integer & rational numbers
        ClassicAssert.IsTrue(new RationalNumber32(2) < new RationalNumber32(7, 3))
        ClassicAssert.AreEqual(-1, (new RationalNumber32(2) :> IComparable).CompareTo(new RationalNumber32(7, 3)))
        ClassicAssert.IsTrue(new RationalNumber32(7, 3) < new RationalNumber32(3))
        ClassicAssert.AreEqual(-1, (new RationalNumber32(7, 3) :> IComparable).CompareTo(new RationalNumber32(3)))
        ClassicAssert.IsTrue(new RationalNumber32(-7, 3) < new RationalNumber32(-2))
        ClassicAssert.AreEqual(-1, (new RationalNumber32(-7, 3) :> IComparable).CompareTo(new RationalNumber32(-2)))
        ClassicAssert.IsTrue(new RationalNumber32(-3) < new RationalNumber32(-7, 3))
        ClassicAssert.AreEqual(-1, (new RationalNumber32(-3) :> IComparable).CompareTo(new RationalNumber32(-7, 3)))
        ClassicAssert.IsTrue(new RationalNumber32(7, 3) > new RationalNumber32(2))
        ClassicAssert.AreEqual(1, (new RationalNumber32(7, 3) :> IComparable).CompareTo(new RationalNumber32(2)))
        ClassicAssert.IsTrue(new RationalNumber32(3) > new RationalNumber32(7, 3))
        ClassicAssert.AreEqual(1, (new RationalNumber32(3) :> IComparable).CompareTo(new RationalNumber32(7, 3)))
        ...
        ClassicAssert.AreEqual(1, (new RationalNumber32(-7, 3) :> IComparable).CompareTo(new RationalNumber32(-3)))
        // two rational numbers
        ClassicAssert.IsTrue(new RationalNumber32(1, 3) < new RationalNumber32(1, 2))
        ClassicAssert.AreEqual(-1, (new RationalNumber32(1, 3) :> IComparable).CompareTo(new RationalNumber32(1, 2)))
        ClassicAssert.IsTrue(new RationalNumber32(-1, 2) < new RationalNumber32(-1, 3))
        ClassicAssert.AreEqual(-1, (new RationalNumber32(-1, 2) :> IComparable).CompareTo(new RationalNumber32(-1, 3)))
        ClassicAssert.IsTrue(new RationalNumber32(2, 5) = new RationalNumber32(2, 5))
        ClassicAssert.AreEqual(0, (new RationalNumber32(2, 5) :> IComparable).CompareTo(new RationalNumber32(2, 5)))
        ClassicAssert.IsTrue(new RationalNumber32(-2, 5) = new RationalNumber32(-2, 5))
        ClassicAssert.AreEqual(0, (new RationalNumber32(-2, 5) :> IComparable).CompareTo(new RationalNumber32(-2, 5)))
        ClassicAssert.IsTrue(new RationalNumber32(2, 5) = new RationalNumber32(4, 10))
        ClassicAssert.AreEqual(0, (new RationalNumber32(2, 5) :> IComparable).CompareTo(new RationalNumber32(4, 10)))
        ClassicAssert.IsTrue(new RationalNumber32(-2, 5) = new RationalNumber32(-4, 10))
        ClassicAssert.AreEqual(0, (new RationalNumber32(-2, 5) :> IComparable).CompareTo(new RationalNumber32(-4, 10)))
        ClassicAssert.IsTrue(new RationalNumber32(4, 10) = new RationalNumber32(2, 5))
        ClassicAssert.AreEqual(0, (new RationalNumber32(4, 10) :> IComparable).CompareTo(new RationalNumber32(2, 5)))
        ClassicAssert.IsTrue(new RationalNumber32(-4, 10) = new RationalNumber32(-2, 5))
        ClassicAssert.AreEqual(0, (new RationalNumber32(-4, 10) :> IComparable).CompareTo(new RationalNumber32(-2, 5)))
        ClassicAssert.IsTrue(new RationalNumber32(1, 2) > new RationalNumber32(1, 3))
        ClassicAssert.AreEqual(1, (new RationalNumber32(1, 2) :> IComparable).CompareTo(new RationalNumber32(1, 3)))
    ...
    member public this.EqualsAndGetHashCode() =
        // two integer numbers
        ClassicAssert.IsTrue((new RationalNumber32(2)).Equals(new RationalNumber32(2)))
        ClassicAssert.AreEqual((new RationalNumber32(2)).GetHashCode(), (new RationalNumber32(2)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber32(-2)).Equals(new RationalNumber32(-2)))
        ClassicAssert.AreEqual((new RationalNumber32(-2)).GetHashCode(), (new RationalNumber32(-2)).GetHashCode())
        ClassicAssert.IsFalse((new RationalNumber32(2)).Equals(new RationalNumber32(3)))
        ClassicAssert.IsFalse((new RationalNumber32(3)).Equals(new RationalNumber32(2)))
        ClassicAssert.IsFalse((new RationalNumber32(-2)).Equals(new RationalNumber32(-3)))
        ClassicAssert.IsFalse((new RationalNumber32(-3)).Equals(new RationalNumber32(-2)))
        // integer & rational numbers
        ClassicAssert.IsFalse((new RationalNumber32(2)).Equals(new RationalNumber32(2, 3)))
        ClassicAssert.IsFalse((new RationalNumber32(2, 3)).Equals(new RationalNumber32(2)))
        ClassicAssert.IsFalse((new RationalNumber32(-2)).Equals(new RationalNumber32(-2, 3)))
        ClassicAssert.IsFalse((new RationalNumber32(-2, 3)).Equals(new RationalNumber32(-2)))
        // two rational numbers
        ClassicAssert.IsTrue((new RationalNumber32(1, 2)).Equals(new RationalNumber32(1, 2)))
        ClassicAssert.AreEqual((new RationalNumber32(1, 2)).GetHashCode(), (new RationalNumber32(1, 2)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber32(-1, 2)).Equals(new RationalNumber32(-1, 2)))
        ClassicAssert.AreEqual((new RationalNumber32(-1, 2)).GetHashCode(), (new RationalNumber32(-1, 2)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber32(2, 5)).Equals(new RationalNumber32(4, 10)))
        ClassicAssert.AreEqual((new RationalNumber32(2, 5)).GetHashCode(), (new RationalNumber32(4, 10)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber32(-2, 5)).Equals(new RationalNumber32(-4, 10)))
        ClassicAssert.AreEqual((new RationalNumber32(-2, 5)).GetHashCode(), (new RationalNumber32(-4, 10)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber32(4, 10)).Equals(new RationalNumber32(2, 5)))
        ClassicAssert.AreEqual((new RationalNumber32(4, 10)).GetHashCode(), (new RationalNumber32(2, 5)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber32(-4, 10)).Equals(new RationalNumber32(-2, 5)))
        ClassicAssert.AreEqual((new RationalNumber32(-4, 10)).GetHashCode(), (new RationalNumber32(-2, 5)).GetHashCode())
        ClassicAssert.IsFalse((new RationalNumber32(1, 2)).Equals(new RationalNumber32(1, 3)))
        ClassicAssert.IsFalse((new RationalNumber32(-1, 2)).Equals(new RationalNumber32(-1, 3)))
        ClassicAssert.IsFalse((new RationalNumber32(1, 3)).Equals(new RationalNumber32(1, 2)))
        ClassicAssert.IsFalse((new RationalNumber32(-1, 3)).Equals(new RationalNumber32(-1, 2)))
        // rational number and other object
        ClassicAssert.IsFalse((new RationalNumber32(1, 2)).Equals(0.5))
        ClassicAssert.IsFalse((0.5).Equals(new RationalNumber32(1, 2)))
        ClassicAssert.IsFalse((new RationalNumber32(1, 2)).Equals("0.5"))
        ClassicAssert.IsFalse("0.5".Equals(new RationalNumber32(1, 2)))

    member private this.Check(extectedNumerator: int, expectedDenominator: int, actualNumber: RationalNumber32) =
        ClassicAssert.AreEqual(extectedNumerator, actualNumber.Numerator)
        ClassicAssert.AreEqual(expectedDenominator, actualNumber.Denominator)
...
type RationalNumber64Tests() =
    ...
    [<Test>]
    member public this.IsZero() =
        ClassicAssert.IsTrue((new RationalNumber64(0L, 1L)).IsZero)
        ClassicAssert.IsFalse((new RationalNumber64(2L, 1L)).IsZero)
        ClassicAssert.IsFalse((new RationalNumber64(2L, 3L)).IsZero)
        ClassicAssert.IsFalse((new RationalNumber64(-2L, 1L)).IsZero)
        ClassicAssert.IsFalse((new RationalNumber64(-2L, 3L)).IsZero)

    [<Test>]
    member public this.IsInteger() =
        ClassicAssert.IsTrue((new RationalNumber64(0L, 1L)).IsInteger)
        ClassicAssert.IsTrue((new RationalNumber64(1L, 1L)).IsInteger)
        ClassicAssert.IsTrue((new RationalNumber64(2L, 1L)).IsInteger)
        ClassicAssert.IsTrue((new RationalNumber64(-1L, 1L)).IsInteger)
        ClassicAssert.IsTrue((new RationalNumber64(-2L, 1L)).IsInteger)
        ClassicAssert.IsFalse((new RationalNumber64(1L, 2L)).IsInteger)
        ClassicAssert.IsFalse((new RationalNumber64(2L, 3L)).IsInteger)
        ClassicAssert.IsFalse((new RationalNumber64(-1L, 2L)).IsInteger)
        ClassicAssert.IsFalse((new RationalNumber64(-2L, 3L)).IsInteger)
    ...
    member public this.Compare() =
        // two integer numbers
        ClassicAssert.IsTrue(new RationalNumber64(2L) < new RationalNumber64(3L))
        ClassicAssert.AreEqual(-1, (new RationalNumber64(2L) :> IComparable).CompareTo(new RationalNumber64(3L)))
        ClassicAssert.IsTrue(new RationalNumber64(-3L) < new RationalNumber64(-2L))
        ClassicAssert.AreEqual(-1, (new RationalNumber64(-3L) :> IComparable).CompareTo(new RationalNumber64(-2L)))
        ClassicAssert.IsTrue(new RationalNumber64(2L) = new RationalNumber64(2L))
        ClassicAssert.AreEqual(0, (new RationalNumber64(2L) :> IComparable).CompareTo(new RationalNumber64(2L)))
        ClassicAssert.IsTrue(new RationalNumber64(-2L) = new RationalNumber64(-2L))
        ClassicAssert.AreEqual(0, (new RationalNumber64(-2L) :> IComparable).CompareTo(new RationalNumber64(-2L)))
        ClassicAssert.IsTrue(new RationalNumber64(3L) > new RationalNumber64(2L))
        ClassicAssert.AreEqual(1, (new RationalNumber64(3L) :> IComparable).CompareTo(new RationalNumber64(2L)))
        ...
        ClassicAssert.AreEqual(1, (new RationalNumber64(-2L) :> IComparable).CompareTo(new RationalNumber64(-3L)))
        // integer & rational numbers
        ClassicAssert.IsTrue(new RationalNumber64(2L) < new RationalNumber64(7L, 3L))
        ClassicAssert.AreEqual(-1, (new RationalNumber64(2L) :> IComparable).CompareTo(new RationalNumber64(7L, 3L)))
        ClassicAssert.IsTrue(new RationalNumber64(7L, 3L) < new RationalNumber64(3L))
        ClassicAssert.AreEqual(-1, (new RationalNumber64(7L, 3L) :> IComparable).CompareTo(new RationalNumber64(3L)))
        ClassicAssert.IsTrue(new RationalNumber64(-7L, 3L) < new RationalNumber64(-2L))
        ClassicAssert.AreEqual(-1, (new RationalNumber64(-7L, 3L) :> IComparable).CompareTo(new RationalNumber64(-2L)))
        ClassicAssert.IsTrue(new RationalNumber64(-3L) < new RationalNumber64(-7L, 3L))
        ClassicAssert.AreEqual(-1, (new RationalNumber64(-3L) :> IComparable).CompareTo(new RationalNumber64(-7L, 3L)))
        ClassicAssert.IsTrue(new RationalNumber64(7L, 3L) > new RationalNumber64(2L))
        ClassicAssert.AreEqual(1, (new RationalNumber64(7L, 3L) :> IComparable).CompareTo(new RationalNumber64(2L)))
        ClassicAssert.IsTrue(new RationalNumber64(3L) > new RationalNumber64(7L, 3L))
        ClassicAssert.AreEqual(1, (new RationalNumber64(3L) :> IComparable).CompareTo(new RationalNumber64(7L, 3L)))
        ...
        ClassicAssert.AreEqual(1, (new RationalNumber64(-7L, 3L) :> IComparable).CompareTo(new RationalNumber64(-3L)))
        // two rational numbers
        ClassicAssert.IsTrue(new RationalNumber64(1L, 3L) < new RationalNumber64(1L, 2L))
        ClassicAssert.AreEqual(-1, (new RationalNumber64(1L, 3L) :> IComparable).CompareTo(new RationalNumber64(1L, 2L)))
        ClassicAssert.IsTrue(new RationalNumber64(-1L, 2L) < new RationalNumber64(-1L, 3L))
        ClassicAssert.AreEqual(-1, (new RationalNumber64(-1L, 2L) :> IComparable).CompareTo(new RationalNumber64(-1L, 3L)))
        ClassicAssert.IsTrue(new RationalNumber64(2L, 5L) = new RationalNumber64(2L, 5L))
        ClassicAssert.AreEqual(0, (new RationalNumber64(2L, 5L) :> IComparable).CompareTo(new RationalNumber64(2L, 5L)))
        ClassicAssert.IsTrue(new RationalNumber64(-2L, 5L) = new RationalNumber64(-2L, 5L))
        ClassicAssert.AreEqual(0, (new RationalNumber64(-2L, 5L) :> IComparable).CompareTo(new RationalNumber64(-2L, 5L)))
        ClassicAssert.IsTrue(new RationalNumber64(2L, 5L) = new RationalNumber64(4L, 10L))
        ClassicAssert.AreEqual(0, (new RationalNumber64(2L, 5L) :> IComparable).CompareTo(new RationalNumber64(4L, 10L)))
        ClassicAssert.IsTrue(new RationalNumber64(-2L, 5L) = new RationalNumber64(-4L, 10L))
        ClassicAssert.AreEqual(0, (new RationalNumber64(-2L, 5L) :> IComparable).CompareTo(new RationalNumber64(-4L, 10L)))
        ClassicAssert.IsTrue(new RationalNumber64(4L, 10L) = new RationalNumber64(2L, 5L))
        ClassicAssert.AreEqual(0, (new RationalNumber64(4L, 10L) :> IComparable).CompareTo(new RationalNumber64(2L, 5L)))
        ClassicAssert.IsTrue(new RationalNumber64(-4L, 10L) = new RationalNumber64(-2L, 5L))
        ClassicAssert.AreEqual(0, (new RationalNumber64(-4L, 10L) :> IComparable).CompareTo(new RationalNumber64(-2L, 5L)))
        ClassicAssert.IsTrue(new RationalNumber64(1L, 2L) > new RationalNumber64(1L, 3L))
        ClassicAssert.AreEqual(1, (new RationalNumber64(1L, 2L) :> IComparable).CompareTo(new RationalNumber64(1L, 3L)))
    ...
    member public this.EqualsAndGetHashCode() =
        // two integer numbers
        ClassicAssert.IsTrue((new RationalNumber64(2L)).Equals(new RationalNumber64(2L)))
        ClassicAssert.AreEqual((new RationalNumber64(2L)).GetHashCode(), (new RationalNumber64(2L)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber64(-2L)).Equals(new RationalNumber64(-2L)))
        ClassicAssert.AreEqual((new RationalNumber64(-2L)).GetHashCode(), (new RationalNumber64(-2L)).GetHashCode())
        ClassicAssert.IsFalse((new RationalNumber64(2L)).Equals(new RationalNumber64(3L)))
        ClassicAssert.IsFalse((new RationalNumber64(3L)).Equals(new RationalNumber64(2L)))
        ClassicAssert.IsFalse((new RationalNumber64(-2L)).Equals(new RationalNumber64(-3L)))
        ClassicAssert.IsFalse((new RationalNumber64(-3L)).Equals(new RationalNumber64(-2L)))
        // integer & rational numbers
        ClassicAssert.IsFalse((new RationalNumber64(2L)).Equals(new RationalNumber64(2L, 3L)))
        ClassicAssert.IsFalse((new RationalNumber64(2L, 3L)).Equals(new RationalNumber64(2L)))
        ClassicAssert.IsFalse((new RationalNumber64(-2L)).Equals(new RationalNumber64(-2L, 3L)))
        ClassicAssert.IsFalse((new RationalNumber64(-2L, 3L)).Equals(new RationalNumber64(-2L)))
        // two rational numbers
        ClassicAssert.IsTrue((new RationalNumber64(1L, 2L)).Equals(new RationalNumber64(1L, 2L)))
        ClassicAssert.AreEqual((new RationalNumber64(1L, 2L)).GetHashCode(), (new RationalNumber64(1L, 2L)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber64(-1L, 2L)).Equals(new RationalNumber64(-1L, 2L)))
        ClassicAssert.AreEqual((new RationalNumber64(-1L, 2L)).GetHashCode(), (new RationalNumber64(-1L, 2L)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber64(2L, 5L)).Equals(new RationalNumber64(4L, 10L)))
        ClassicAssert.AreEqual((new RationalNumber64(2L, 5L)).GetHashCode(), (new RationalNumber64(4L, 10L)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber64(-2L, 5L)).Equals(new RationalNumber64(-4L, 10L)))
        ClassicAssert.AreEqual((new RationalNumber64(-2L, 5L)).GetHashCode(), (new RationalNumber64(-4L, 10L)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber64(4L, 10L)).Equals(new RationalNumber64(2L, 5L)))
        ClassicAssert.AreEqual((new RationalNumber64(4L, 10L)).GetHashCode(), (new RationalNumber64(2L, 5L)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber64(-4L, 10L)).Equals(new RationalNumber64(-2L, 5L)))
        ClassicAssert.AreEqual((new RationalNumber64(-4L, 10L)).GetHashCode(), (new RationalNumber64(-2L, 5L)).GetHashCode())
        ClassicAssert.IsFalse((new RationalNumber64(1L, 2L)).Equals(new RationalNumber64(1L, 3L)))
        ClassicAssert.IsFalse((new RationalNumber64(-1L, 2L)).Equals(new RationalNumber64(-1L, 3L)))
        ClassicAssert.IsFalse((new RationalNumber64(1L, 3L)).Equals(new RationalNumber64(1L, 2L)))
        ClassicAssert.IsFalse((new RationalNumber64(-1L, 3L)).Equals(new RationalNumber64(-1L, 2L)))
        // rational number and other object
        ClassicAssert.IsFalse((new RationalNumber64(1L, 2L)).Equals(0.5))
        ClassicAssert.IsFalse((0.5).Equals(new RationalNumber64(1L, 2L)))
        ClassicAssert.IsFalse((new RationalNumber64(1L, 2L)).Equals("0.5"))
        ClassicAssert.IsFalse("0.5".Equals(new RationalNumber64(1L, 2L)))
    ...
    member private this.Check(expectedNumerator: int64, expectedDenominator: int64, actualNumber: RationalNumber64) =
        ClassicAssert.AreEqual(expectedNumerator, actualNumber.Numerator)
        ClassicAssert.AreEqual(expectedDenominator, actualNumber.Denominator)
...
type RationalNumberTests() =
    ...
    [<Test>]
    member public this.IsZero() =
        ClassicAssert.IsTrue((new RationalNumber(0I, 1I)).IsZero)
        ClassicAssert.IsFalse((new RationalNumber(2I, 1I)).IsZero)
        ClassicAssert.IsFalse((new RationalNumber(2I, 3I)).IsZero)
        ClassicAssert.IsFalse((new RationalNumber(-2I, 1I)).IsZero)
        ClassicAssert.IsFalse((new RationalNumber(-2I, 3I)).IsZero)

    [<Test>]
    member public this.IsInteger() =
        ClassicAssert.IsTrue((new RationalNumber(0I, 1I)).IsInteger)
        ClassicAssert.IsTrue((new RationalNumber(1I, 1I)).IsInteger)
        ClassicAssert.IsTrue((new RationalNumber(2I, 1I)).IsInteger)
        ClassicAssert.IsTrue((new RationalNumber(-1I, 1I)).IsInteger)
        ClassicAssert.IsTrue((new RationalNumber(-2I, 1I)).IsInteger)
        ClassicAssert.IsFalse((new RationalNumber(1I, 2I)).IsInteger)
        ClassicAssert.IsFalse((new RationalNumber(2I, 3I)).IsInteger)
        ClassicAssert.IsFalse((new RationalNumber(-1I, 2I)).IsInteger)
        ClassicAssert.IsFalse((new RationalNumber(-2I, 3I)).IsInteger)
    ...
    member public this.Compare() =
        // two integer numbers
        ClassicAssert.IsTrue(new RationalNumber(2I) < new RationalNumber(3I))
        ClassicAssert.AreEqual(-1, (new RationalNumber(2I) :> IComparable).CompareTo(new RationalNumber(3I)))
        ClassicAssert.IsTrue(new RationalNumber(-3I) < new RationalNumber(-2I))
        ClassicAssert.AreEqual(-1, (new RationalNumber(-3I) :> IComparable).CompareTo(new RationalNumber(-2I)))
        ClassicAssert.IsTrue(new RationalNumber(2I) = new RationalNumber(2I))
        ClassicAssert.AreEqual(0, (new RationalNumber(2I) :> IComparable).CompareTo(new RationalNumber(2I)))
        ClassicAssert.IsTrue(new RationalNumber(-2I) = new RationalNumber(-2I))
        ClassicAssert.AreEqual(0, (new RationalNumber(-2I) :> IComparable).CompareTo(new RationalNumber(-2I)))
        ClassicAssert.IsTrue(new RationalNumber(3I) > new RationalNumber(2I))
        ClassicAssert.AreEqual(1, (new RationalNumber(3I) :> IComparable).CompareTo(new RationalNumber(2I)))
        ...
        ClassicAssert.AreEqual(1, (new RationalNumber(-2I) :> IComparable).CompareTo(new RationalNumber(-3I)))
        // integer & rational numbers
        ClassicAssert.IsTrue(new RationalNumber(2I) < new RationalNumber(7I, 3I))
        ClassicAssert.AreEqual(-1, (new RationalNumber(2I) :> IComparable).CompareTo(new RationalNumber(7I, 3I)))
        ClassicAssert.IsTrue(new RationalNumber(7I, 3I) < new RationalNumber(3I))
        ClassicAssert.AreEqual(-1, (new RationalNumber(7I, 3I) :> IComparable).CompareTo(new RationalNumber(3I)))
        ClassicAssert.IsTrue(new RationalNumber(-7I, 3I) < new RationalNumber(-2I))
        ClassicAssert.AreEqual(-1, (new RationalNumber(-7I, 3I) :> IComparable).CompareTo(new RationalNumber(-2I)))
        ClassicAssert.IsTrue(new RationalNumber(-3I) < new RationalNumber(-7I, 3I))
        ClassicAssert.AreEqual(-1, (new RationalNumber(-3I) :> IComparable).CompareTo(new RationalNumber(-7I, 3I)))
        ClassicAssert.IsTrue(new RationalNumber(7I, 3I) > new RationalNumber(2I))
        ClassicAssert.AreEqual(1, (new RationalNumber(7I, 3I) :> IComparable).CompareTo(new RationalNumber(2I)))
        ClassicAssert.IsTrue(new RationalNumber(3I) > new RationalNumber(7I, 3I))
        ClassicAssert.AreEqual(1, (new RationalNumber(3I) :> IComparable).CompareTo(new RationalNumber(7I, 3I)))
        ...
        ClassicAssert.AreEqual(1, (new RationalNumber(-7I, 3I) :> IComparable).CompareTo(new RationalNumber(-3I)))
        // two rational numbers
        ClassicAssert.IsTrue(new RationalNumber(1I, 3I) < new RationalNumber(1I, 2I))
        ClassicAssert.AreEqual(-1, (new RationalNumber(1I, 3I) :> IComparable).CompareTo(new RationalNumber(1I, 2I)))
        ClassicAssert.IsTrue(new RationalNumber(-1I, 2I) < new RationalNumber(-1I, 3I))
        ClassicAssert.AreEqual(-1, (new RationalNumber(-1I, 2I) :> IComparable).CompareTo(new RationalNumber(-1I, 3I)))
        ClassicAssert.IsTrue(new RationalNumber(2I, 5I) = new RationalNumber(2I, 5I))
        ClassicAssert.AreEqual(0, (new RationalNumber(2I, 5I) :> IComparable).CompareTo(new RationalNumber(2I, 5I)))
        ClassicAssert.IsTrue(new RationalNumber(-2I, 5I) = new RationalNumber(-2I, 5I))
        ClassicAssert.AreEqual(0, (new RationalNumber(-2I, 5I) :> IComparable).CompareTo(new RationalNumber(-2I, 5I)))
        ClassicAssert.IsTrue(new RationalNumber(2I, 5I) = new RationalNumber(4I, 10I))
        ClassicAssert.AreEqual(0, (new RationalNumber(2I, 5I) :> IComparable).CompareTo(new RationalNumber(4I, 10I)))
        ClassicAssert.IsTrue(new RationalNumber(-2I, 5I) = new RationalNumber(-4I, 10I))
        ClassicAssert.AreEqual(0, (new RationalNumber(-2I, 5I) :> IComparable).CompareTo(new RationalNumber(-4I, 10I)))
        ClassicAssert.IsTrue(new RationalNumber(4I, 10I) = new RationalNumber(2I, 5I))
        ClassicAssert.AreEqual(0, (new RationalNumber(4I, 10I) :> IComparable).CompareTo(new RationalNumber(2I, 5I)))
        ClassicAssert.IsTrue(new RationalNumber(-4I, 10I) = new RationalNumber(-2I, 5I))
        ClassicAssert.AreEqual(0, (new RationalNumber(-4I, 10I) :> IComparable).CompareTo(new RationalNumber(-2I, 5I)))
        ClassicAssert.IsTrue(new RationalNumber(1I, 2I) > new RationalNumber(1I, 3I))
        ClassicAssert.AreEqual(1, (new RationalNumber(1I, 2I) :> IComparable).CompareTo(new RationalNumber(1I, 3I)))
    ...
    member public this.EqualsAndGetHashCode() =
        // two integer numbers
        ClassicAssert.IsTrue((new RationalNumber(2I)).Equals(new RationalNumber(2I)))
        ClassicAssert.AreEqual((new RationalNumber(2I)).GetHashCode(), (new RationalNumber(2I)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber(-2I)).Equals(new RationalNumber(-2I)))
        ClassicAssert.AreEqual((new RationalNumber(-2I)).GetHashCode(), (new RationalNumber(-2I)).GetHashCode())
        ClassicAssert.IsFalse((new RationalNumber(2I)).Equals(new RationalNumber(3I)))
        ClassicAssert.IsFalse((new RationalNumber(3I)).Equals(new RationalNumber(2I)))
        ClassicAssert.IsFalse((new RationalNumber(-2I)).Equals(new RationalNumber(-3I)))
        ClassicAssert.IsFalse((new RationalNumber(-3I)).Equals(new RationalNumber(-2I)))
        // integer & rational numbers
        ClassicAssert.IsFalse((new RationalNumber(2I)).Equals(new RationalNumber(2I, 3I)))
        ClassicAssert.IsFalse((new RationalNumber(2I, 3I)).Equals(new RationalNumber(2I)))
        ClassicAssert.IsFalse((new RationalNumber(-2I)).Equals(new RationalNumber(-2I, 3I)))
        ClassicAssert.IsFalse((new RationalNumber(-2I, 3I)).Equals(new RationalNumber(-2I)))
        // two rational numbers
        ClassicAssert.IsTrue((new RationalNumber(1I, 2I)).Equals(new RationalNumber(1I, 2I)))
        ClassicAssert.AreEqual((new RationalNumber(1I, 2I)).GetHashCode(), (new RationalNumber(1I, 2I)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber(-1I, 2I)).Equals(new RationalNumber(-1I, 2I)))
        ClassicAssert.AreEqual((new RationalNumber(-1I, 2I)).GetHashCode(), (new RationalNumber(-1I, 2I)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber(2I, 5I)).Equals(new RationalNumber(4I, 10I)))
        ClassicAssert.AreEqual((new RationalNumber(2I, 5I)).GetHashCode(), (new RationalNumber(4I, 10I)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber(-2I, 5I)).Equals(new RationalNumber(-4I, 10I)))
        ClassicAssert.AreEqual((new RationalNumber(-2I, 5I)).GetHashCode(), (new RationalNumber(-4I, 10I)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber(4I, 10I)).Equals(new RationalNumber(2I, 5I)))
        ClassicAssert.AreEqual((new RationalNumber(4I, 10I)).GetHashCode(), (new RationalNumber(2I, 5I)).GetHashCode())
        ClassicAssert.IsTrue((new RationalNumber(-4I, 10I)).Equals(new RationalNumber(-2I, 5I)))
        ClassicAssert.AreEqual((new RationalNumber(-4I, 10I)).GetHashCode(), (new RationalNumber(-2I, 5I)).GetHashCode())
        ClassicAssert.IsFalse((new RationalNumber(1I, 2I)).Equals(new RationalNumber(1I, 3I)))
        ClassicAssert.IsFalse((new RationalNumber(-1I, 2I)).Equals(new RationalNumber(-1I, 3I)))
        ClassicAssert.IsFalse((new RationalNumber(1I, 3I)).Equals(new RationalNumber(1I, 2I)))
        ClassicAssert.IsFalse((new RationalNumber(-1I, 3I)).Equals(new RationalNumber(-1I, 2I)))
        // rational number and other object
        ClassicAssert.IsFalse((new RationalNumber(1I, 2I)).Equals(0.5))
        ClassicAssert.IsFalse((0.5).Equals(new RationalNumber(1I, 2I)))
        ClassicAssert.IsFalse((new RationalNumber(1I, 2I)).Equals("0.5"))
        ClassicAssert.IsFalse("0.5".Equals(new RationalNumber(1I, 2I)))
