...
type PythagoreanTriplesGeneratorTests() =
    ...
    member public this.GeneratePrimitiveWithZSelector() =
        ...
        ClassicAssert.AreEqual(expextedZ100 |> Array.map (fun triple -> triple |> createTriple), actualZ100)
        ...
        ClassicAssert.AreEqual(expectedZ100300 |> Array.map (fun triple -> triple |> createTriple), actualZ100300)
    ...
    member public this.GenerateWithZSelector() =
        ...
        ClassicAssert.AreEqual(expexted |> Array.map (fun triple -> triple |> createTriple), actual)
