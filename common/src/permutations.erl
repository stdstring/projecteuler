...
-spec get_permutation_impl(LexographicNumber :: non_neg_integer(), AlphabetRest :: array:array(term()), AlphabetRestCount :: non_neg_integer(), Result :: [term()]) -> [term()].
...
find_item(AlphabetRest, AlphabetSize, 0, Index) ->
    case array:get(Index, AlphabetRest) of
        undefined -> find_item(AlphabetRest, AlphabetSize, 0, Index + 1);
        Item -> {Item, array:set(Index, undefined, AlphabetRest)}
    end;
find_item(AlphabetRest, AlphabetSize, ItemIndex, Index) ->
    case array:get(Index, AlphabetRest) of
        undefined -> find_item(AlphabetRest, AlphabetSize, ItemIndex, Index + 1);
...
-spec get_lexographic_number_impl(Items :: [term()], ItemsCount :: pos_integer(), AlphabetRest :: array:array(term()), Result :: non_neg_integer()) -> non_neg_integer().
...
-spec find_index(AlphabetRest :: array:array(term()), SearchedItem :: term()) -> {SearchedIndex :: non_neg_integer(), AlphabetRest :: array:array(term())}.
find_index(AlphabetRest, SearchedItem) ->
    find_index_impl(AlphabetRest, SearchedItem, 0, 0, array:size(AlphabetRest)).

-spec find_index_impl(AlphabetRest :: array:array(term()), SearchedItem :: term(), SearchedIndex :: non_neg_integer(), Index :: non_neg_integer(), AlphabetCount :: pos_integer()) ->
    {SearchedIndex :: non_neg_integer(), AlphabetRest :: array:array(term())}.
...
find_index_impl(AlphabetRest, SearchedItem, SearchedIndex, Index, AlphabetCount) ->
    ...
    if
        Item == undefined -> find_index_impl(AlphabetRest, SearchedItem, SearchedIndex, Index + 1, AlphabetCount);
        Item /= SearchedItem -> find_index_impl(AlphabetRest, SearchedItem, SearchedIndex + 1, Index + 1, AlphabetCount);
        Item == SearchedItem -> {SearchedIndex, array:set(Index, undefined, AlphabetRest)}
    end.