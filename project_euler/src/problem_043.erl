...
%% process d8d9d10
-spec process_number(Digits :: [0..9], Number :: pos_integer(), Result :: [pos_integer()]) -> [pos_integer()].
...
%% process d7d8d9
-spec process_number(ProcessedDigits :: [0..9], Digits :: [0..9], Digit8 :: 0..9, Digit9 :: 0..9, Digit10 :: 0..9, Result :: [pos_integer()]) -> [pos_integer()].
...
process_number([Digit7 | Digit7Rest], Digits, Digit8, Digit9, Digit10, Result) ->
    ...
    Rem13 = Number rem 13,
    if
        Rem13 /= 0 -> process_number(Digit7Rest, Digits, Digit8, Digit9, Digit10, Result);
        Rem13 == 0 ->
...
%% process d6d7d8
-spec process_number(ProcessedDigits :: [0..9], Digits :: [0..9], Digit7 :: 0..9, Digit8 :: 0..9, Digit9 :: 0..9, Digit10 :: 0..9, Result :: [pos_integer()]) -> [pos_integer()].
...
process_number([Digit6 | Digit6Rest], Digits, Digit7, Digit8, Digit9, Digit10, Result) when Digit6 == 0; Digit6 == 5->
    ...
    Rem11 = Number rem 11,
    if
        Rem11 /= 0 -> process_number(Digit6Rest, Digits, Digit7, Digit8, Digit9, Digit10, Result);
        Rem11 == 0 ->
...
%% process d5d6d7
-spec process_number(ProcessedDigits :: [0..9], Digits :: [0..9], Digit6 :: 0..9, Digit7 :: 0..9, Digit8 :: 0..9, Digit9 :: 0..9, Digit10 :: 0..9, Result :: [pos_integer()]) -> [pos_integer()].
...
process_number([Digit5 | Digit5Rest], Digits, Digit6, Digit7, Digit8, Digit9, Digit10, Result) ->
    ...
    Rem7 = Number rem 7,
    if
        Rem7 /= 0 -> process_number(Digit5Rest, Digits, Digit6, Digit7, Digit8, Digit9, Digit10, Result);
        Rem7 == 0 ->
...
%% process d4d5d6
-spec process_number(ProcessedDigits :: [0..9], Digits :: [0..9], Digit5 :: 0..9, Digit6 :: 0..9, Digit7 :: 0..9, Digit8 :: 0..9, Digit9 :: 0..9, Digit10 :: 0..9, Result :: [pos_integer()]) ->
    [pos_integer()].
...
%% process d3d4d5
-spec process_number(ProcessedDigits :: [0..9],
                     Digits :: [0..9],
                     Digit4 :: 0..9,
                     Digit5 :: 0..9,
                     Digit6 :: 0..9,
...
process_number([Digit3 | Digit3Rest], Digits, Digit4, Digit5, Digit6, Digit7, Digit8, Digit9, Digit10, Result) ->
    ...
    Rem3 = Number rem 3,
    if
        Rem3 /= 0 -> process_number(Digit3Rest, Digits, Digit4, Digit5, Digit6, Digit7, Digit8, Digit9, Digit10, Result);
        Rem3 == 0 ->
...
-spec collect(Digits :: [0..9], Digit3 :: 0..9, Digit4 :: 0..9, Digit5 :: 0..9, Digit6 :: 0..9, Digit7 :: 0..9, Digit8 :: 0..9, Digit9 :: 0..9, Digit10 :: 0..9, Result :: [pos_integer()]) ->
    [pos_integer()].
...
-spec check_d8d9d10_part(Digit8 :: 0..9, Digit9 :: 0..9, Digit10 :: 0..9) -> boolean().
...
-spec get_digits(Number :: pos_integer()) -> [0..9].
