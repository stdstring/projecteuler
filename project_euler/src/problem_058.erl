...
solve(Ratio) ->
    process_spiral(1, 1, Ratio, {1, 0}).

-spec process_spiral(LastNumber :: pos_integer(), SideSize :: pos_integer(), Ratio :: float(), {ProcessedCount :: non_neg_integer(), PrimeCount :: non_neg_integer()}) -> pos_integer().
...
-spec process_numbers(Numbers :: [pos_integer()], {ProcessedCount :: non_neg_integer(), PrimeCount :: non_neg_integer()}) ->
    {ProcessedCount :: non_neg_integer(), PrimeCount :: non_neg_integer()}.
